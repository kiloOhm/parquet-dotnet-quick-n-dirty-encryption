...
namespace Parquet.Test.Bloom {
    ...
    /// </summary>
    public sealed class Bloom_SpecCompliance_Tests {
        // --------- helpers ---------

        private static ParquetOptions Opts(bool enable) =>
            new ParquetOptions { EnableBloomFilters = enable };
        ...
        public async Task DictionaryEncoded_Bloom_Uses_Dictionary_Values() {
            ...
            using var ms = new MemoryStream();
            var writer = new DataColumnWriter(ms, footer, se,
                CompressionMethod.None, Opts(true),
        ...
        public async Task Float_Double_PlainEncoding_RoundTrip_And_Prune() {
            ...
            // DOUBLE
            {
                ...
                var reader = new DataColumnReader(field, ms, chunk,
                    new DataColumnStatistics { NullCount = 0 }, footer, Opts(true));
        ...
        public async Task Nullable_Int_Nulls_Are_Not_Hashed() {
            ...
            ms.Position = 0;
            var reader = new DataColumnReader(field, ms, chunk,
                new DataColumnStatistics { NullCount = vals.Count(v => v == null) }, footer, Opts(true));
